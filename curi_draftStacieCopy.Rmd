...
load_old_mutational_matrix<- 
  function(filename,
          mut.order="~/CURI 2022/curi2022/mutational_sig_oec/supplied_data/mut_sig.order.csv") {
...
load_cosmic_matrix<- function(mut.order="~/CURI 2022/curi2022/mutational_sig_oec/supplied_data/mut_sig.order.csv") {
...
signatures <- read_csv("~/CURI 2022/curi2022/mutational_sig_oec/supplied_data/mutational.sig.csv")

# Load sequencing/cohort info for samples, filter with at
# at least 5 million Mb covered
sample.info <-
    read_csv("~/CURI 2022/curi2022/mutational_sig_oec/supplied_data/sample.info.csv") %>%
    filter (area.cov > 5e6)
```
...
data <- read_csv("~/CURI 2022/curi2022/Data/P3_sig.csv")
