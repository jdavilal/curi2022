...
plot_sample_prof(10,6,2000,8000)
#generate_sample_prof(A, B, n1, n2)
sample_profile <- generate_sample_prof(10,6,2000,8000)
#lm_test(sample_profile, A, B)
lm_test(sample_profile,10,6)

sample_profile <- generate_sample_prof(10,6,200,800)
lm_test(sample_profile,10,6)

sample_profile <- generate_sample_prof(1,6,10,100)
lm_test(sample_profile,1,6)

sample_profile <- generate_sample_prof(6,10,100,900)
lm_test(sample_profile,6,10)
```
...
coeff_change <- function(n, A, B){
  ...
  for (i in sum_n){
    for (j in percent){
      sample_profile <- generate_sample_prof(A,B,i*j,i*(1-j))
      coeff <- lm_test(sample_profile,A,B)
