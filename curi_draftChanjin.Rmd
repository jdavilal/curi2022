...
estimate_coeff(sample_profile, sigs = c("SBS10a"), tissue_type = "BRCA", scale = "exome", quantiles = c("5%", "95%"), mb_size = 50)
...
eval_df %>%
  mutate(
    diff = abs(expected_list - actual_list),
